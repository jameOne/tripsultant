...
export const MEDIAQUERIES_FEATURE_KEY = 'mediaQueries';
...
export interface MediaQueriesPartialState {
  readonly [MEDIAQUERIES_FEATURE_KEY]: MediaQueriesState;
}
...
export function MEDIAQUERIES_REDUCER(state: MediaQueriesState | undefined, action: Action) {
