...
import { MediaQueriesState, initialMediaQueriesState, MEDIAQUERIES_REDUCER } from './media-queries.reducer';
...
describe('MediaQueries Reducer', () => {
  ...
  beforeEach(async(() => {
    ...
    result = MEDIAQUERIES_REDUCER(initialMediaQueriesState, action);
  }));
  ...
  describe('selectMediaQuery()', () => {
    it('should select ids ', () => {
      ...
      result = MEDIAQUERIES_REDUCER(result, action)
